...
<div class="container mt-xl-50 mt-sm-30 mt-15">
    ...
    <div class="hk-pg-header align-items-top">
        <div>
            {{-- <a href="{{ url('register') }}" class=" btn btn-primary m-2">Add Promoter</a> --}}
            <h2 class="hk-pg-title font-weight-600 mb-10">Consulting Management</h2>
                    ...
                    <div class="card-group hk-dash-type-2">
                        <div class="card card-sm">
                            <div class="card-body">
                                ...
                                <div>
                                    <span class="d-block display-4 text-dark mb-5"><span class="counter-anim">50</span></span>
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-5">
                                    <div>
                                        <span class="d-block font-15 text-dark font-weight-500">STORE</span>
                                    </div>
                                    <div>
