...
<body>
                    ...
                    <a class="nav-link dropdown-toggle no-caret" href="" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <div class="media-img-wrap">
                                <div class="avatar">
                                    <img src="{{ asset('images/icons/favicon.png') }}" alt="Admin" class="avatar-img">
                                </div>
    ...
    <script type="text/javascript" defer src="{{ asset('assets/vendors/vectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
    <script type="text/javascript" defer src="{{ asset('assets/vendors/vectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script type="text/javascript" defer src="{{ asset('assets/dist/js/vectormap-data.js') }}"></script>
	...
	<script type="text/javascript" defer src="{{ asset('assets/dist/js/dashboard-data.js') }}"></script>
